...
def create_cartesian_controller(model: str, interface: str) -> arx5.Arx5CartesianController:
    ...
    return arx5.Arx5CartesianController(robot_config, controller_config, interface)
...
class Arx5Server:
    def __init__(
        ...
        self.arx5_cartesian_controller = create_cartesian_controller(model, interface)
            ...
            try:
                ...
                if self.socket in socks and socks[self.socket] == zmq.POLLIN:
                    ...
                    if self.arx5_cartesian_controller is None:
                        ...
                        self.arx5_cartesian_controller = create_cartesian_controller(self.model, self.interface)
                else:
